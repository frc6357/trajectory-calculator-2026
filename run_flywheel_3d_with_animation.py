...
HUB_CLEARANCE = 0.52  # buffer from hub edges
...
def simulate():
    ...
    robot_pos_field = np.array([2.0, 1.0, ROBOT_POS_Z_F])
    # Robot yaw angle (rotated 10° counterclockwise)
    robot_yaw_field = np.deg2rad(10)
    # Robot velocity (right, forward, up)
    robot_velocity_field = np.array([1, 3, ROBOT_VEL_Z_F])
